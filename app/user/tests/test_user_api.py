...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Creating a user already exists fails"""
    ...
    def test_create_token_invalid_crediantials(self):
        """Test that token is not created if invalid crediantials are given"""
        create_user(
            email='test@londonappdev.com',
...
class PrivateUserApiTests(TestCase):
    ...
    def test_retrueve_profile_success(self):
        """Test retrueving profile for logged in user"""
        res = self.client.get(ME_URL)
